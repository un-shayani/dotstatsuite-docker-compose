...
> |MARIADB_ROOT_USER|Admin user of MariaDb database, should always be set to root|root
...
> |MARIADB_PORT|Port of MariaDb Server|4306
...
> |STRUCT_DB_DESIGN_SERVER|Name of the database server (Design dataspace)|db (default name of MS SQL instance running in container, default MariaDb instance is **mariadb**)
...
> |STRUCT_DB_RELEASE_SERVER|Name of the database server (Release dataspace)|db (default name of MS SQL instance running in container, default MariaDb instance is **mariadb**)
...
> |DATA_DB_RELEASE_SERVER|Name of the database server (Release dataspace)|db (default name of MS SQL instance running in container, default MariaDb instance is **mariadb**)
...
> |COMMON_DB_SERVER|Name of the database server of common database|db (default name of MS SQL instance running in container, default MariaDb instance is **mariadb**)
...
But if you'd like **to access** the .Stat Suite installation **from other machines, you have to update HOST** value in the *.env* file to the hostname or ip address of your machine that runs the docker containers, e.g.:
...
> The script uses jsonlint-php tool to check all json files in the *config/configs/* folder.
> 
...
In the default docker-compose installation the configuration files of DE and DLM components are located in *$DOTSTATSUITE-DOCKER-COMPOSE-ROOT/demo/config/configs/* folder:
